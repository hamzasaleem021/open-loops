...
Then open: http://localhost:8000/open-loops.html
...
Select your main branch, root folder.
Your app will be live at https://YOUR_USERNAME.github.io/REPO_NAME/open-loops.html.
Sync setup (optional)
